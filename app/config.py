...
CRAWLER_LOAD_MORE_ITEM_LIMIT = int(os.getenv("CRAWLER_LOAD_MORE_ITEM_LIMIT", "30"))
...
PASSIVE_CRAWLER_ENABLED = os.getenv("PASSIVE_CRAWLER_ENABLED", "").strip().lower() in {
    "1",
    "true",
    "yes",
    "on",
}
PASSIVE_CRAWLER_INTERVAL_SECONDS = int(os.getenv("PASSIVE_CRAWLER_INTERVAL_SECONDS", "3600"))
PASSIVE_CRAWLER_INITIAL_DELAY_SECONDS = int(os.getenv("PASSIVE_CRAWLER_INITIAL_DELAY_SECONDS", "300"))
PASSIVE_CRAWLER_PAGE_LIMIT = int(os.getenv("PASSIVE_CRAWLER_PAGE_LIMIT", "2"))
PASSIVE_CRAWLER_ITEM_LIMIT = int(os.getenv("PASSIVE_CRAWLER_ITEM_LIMIT", "10"))
PASSIVE_CRAWLER_SLEEP_SECONDS = float(os.getenv("PASSIVE_CRAWLER_SLEEP_SECONDS", "1.0"))
PASSIVE_CRAWLER_IMDB_ITEM_LIMIT = int(os.getenv("PASSIVE_CRAWLER_IMDB_ITEM_LIMIT", "0"))
PASSIVE_CRAWLER_BAN_COUNTRIES = os.getenv("PASSIVE_CRAWLER_BAN_COUNTRIES", "Россия,СССР")
PASSIVE_CRAWLER_SECTIONS = os.getenv("PASSIVE_CRAWLER_SECTIONS", "films,series,cartoons,animation")
PASSIVE_CRAWLER_GENRE_SLUGS = os.getenv("PASSIVE_CRAWLER_GENRE_SLUGS", "")
PASSIVE_CRAWLER_STATE_SCOPE = os.getenv("PASSIVE_CRAWLER_STATE_SCOPE", "passive:v1")
